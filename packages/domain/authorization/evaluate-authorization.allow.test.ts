...
import { Permission, IdentityState, SystemRole, MembershipStatus, TeamRoles } from "../../shared-types";
  ...
  const cases = [
    {
      ...
      request: {
        subject: { identityState: IdentityState.Active , systemRole: SystemRole.PlatformModerator },
